...
(function () {
  ...
  exp.addEventListener('change', function (e) {
    return exp.nextElementSibling.innerHTML = e.target.files[0].name;
  });
  imp.addEventListener('change', function (e) {
    return imp.nextElementSibling.innerHTML = e.target.files[0].name;
  });
  ...
  select.addEventListener('click', function (_ref) {
    ...
    if (select.classList.contains('select--open') & target.tagName === 'LI') {
      var _ref2 = [target.innerHTML, selectValue.innerHTML];
      selectValue.innerHTML = _ref2[0];
      target.innerHTML = _ref2[1];
    }
